...
namespace BGE.Scenarios
{
    public abstract class Scenario
    {
		...
		public GameObject smallEnemyPrefab = SteeringManager.Instance.smallEnemyPrefab;
		public GameObject largeEnemyPrefab = SteeringManager.Instance.largeEnemyPrefab;
		public GameObject smallAllyPrefab = SteeringManager.Instance.smallAllyPrefab;
		public GameObject largeAllyPrefab = SteeringManager.Instance.largeAllyPrefab;
		public GameObject planet = SteeringManager.Instance.planet;
