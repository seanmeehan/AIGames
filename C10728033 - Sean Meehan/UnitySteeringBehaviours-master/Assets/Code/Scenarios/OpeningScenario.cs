...
{
	class OpeningScenario : Scenario
	{
		...
		public override void Start()
		{
			...
			leader = CreateBoid(new Vector3(0, 10, 0), leaderPrefab);
			...
			leader.GetComponent<SteeringBehaviours>().seekTargetPos = new Vector3(400, 30, 80);
			...
			origonalFollower = CreateBoid(new Vector3(-20, 100, 30), smallEnemyPrefab);
